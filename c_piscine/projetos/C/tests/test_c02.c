...
int	main(void)
{
	...
	char test_strcpy[100] = "asdwas";
	char test_strcpy2[100] = "ksokdwif";
	char test_strncpy[100] = "ldasknd ";
	char test_strncpy2[100] = "SHDOAISN";
	...
	printf("EX01 - %s\n", ft_strncpy(test_strncpy, src, 25));
 	printf("EX01 - %s - função nativa\n\n", strncpy(test_strncpy2, src, 25));
